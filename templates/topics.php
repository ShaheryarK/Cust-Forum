<?php include('includes/header.php'); ?>
  <ul id="topics">
			 ...
			 <div class="row">
			 <div class="col-md-2">
			 <img class="avatar pull-left" src="images/avatars/<?php echo $topic->avatar; ?>" width="100px" height="80px" />
			 </div>
			 <div class="col-md-10">
			 ...
			 <a href="topics.php?category=<?php echo urlFormat($topic->category_id);?>>"><?php echo $topic->name;?></a>>>
			  <a href="topics.php?user=<?php echo urlFormat($topic->user_id);?>"><?php echo $topic->username;?></a> >><?php echo formatDate($topic->create_date);?><br>
