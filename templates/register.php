<?php include('includes/header.php'); ?>
 <form role="form" enctype="multipart/form-data" method="post" action="register.php">
						 ...
						 <div class="form-group">
						   ...
						   <textarea id="about" rows="6" cols="80" class="form control" name="about" placeholder="Enter us about yourself (Optional)"></textarea>
						 </div>
						 <input name="register" type="submit" class="btn bbtn-default" value="Register"/>
					</form>
