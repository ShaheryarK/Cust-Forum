...
<html lang="en">
  <head>
    ...
    <title>Welcome To Cust Forum</title>
   ...
   <?php 
    //Check if title is set, if not assgin it
	if(!isset($title)){
		$title =SITE_TITLE; 
	}
	?> 
  ...
  <body>
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.php">Cust Forum</a>
        </div>
	...
	<div class="col-md-8">
	  <div class="main-col">
		 ...
		 <h4 class="pull-right">A simple PHP forum engine made by STAK</h4>
